...
import net.simonvt.menudrawer.compat.ViewUtil;
...
@SuppressLint("NewApi")
public class OverlayDrawer2 extends DraggableDrawer {
    ...
    OverlayDrawer2(Activity activity, int dragMode) {
        super(activity, dragMode);
    }

    public OverlayDrawer2(Context context) {
        super(context);
    }

    public OverlayDrawer2(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public OverlayDrawer2(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void initDrawer(Context context, AttributeSet attrs, int defStyle) {
        ...
        super.addView(mMenuContainer, -1, new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT));
//        mPeekSize = dpToPx(20);
        mPeekSize = 0;
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(ViewUtil.resolveSizeAndState(maxWidth, widthMeasureSpec, childState),
        		ViewUtil.resolveSizeAndState(maxHeight, heightMeasureSpec,
